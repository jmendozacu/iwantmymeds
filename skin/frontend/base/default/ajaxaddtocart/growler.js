...
Growler = (function(){
	...
	return Class.create({
		...
		,warn: function(msg, options){
			return specialNotice(this.growler, msg, options, " ", "#3399cc", "#fff");
		}
		,error: function(msg, options){
			return specialNotice(this.growler, msg, options, " ", "red", "#fff");
		}
		,info: function(msg, options){
			return specialNotice(this.growler, msg, options, " ", "#11b400", "#fff");
		}
