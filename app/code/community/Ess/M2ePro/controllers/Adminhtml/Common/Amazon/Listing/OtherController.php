    ...
    extends Ess_M2ePro_Controller_Adminhtml_Common_MainController
{
    ...
    public function gridAction()
    {
        $response = $this->loadLayout()->getLayout()
                         ->createBlock('M2ePro/adminhtml_common_amazon_listing_other_view_grid')->toHtml();
    ...
    {
        /** @var $block Ess_M2ePro_Block_Adminhtml_Common_Amazon_Listing_Other_View */
        $block = $this->getLayout()->createBlock('M2ePro/adminhtml_common_amazon_listing_other_view');
